    ...
    def run(self):
        ...
        try:
            while True:
                ...
                if frame_count % frames_per_sequence == 0 and frame_count != 0:
                    ...
                    if len(tracked_objects.keys()) == 0:
                        ...
                        exist_unknown_object = self.unknown_detector.has_unknown_objects_in_depth_frames(frames_depth_estimation, self.unknown_edge_margin, self.unknown_box_h_threshold)
                    ...
                    cv2.imshow("Real-Time Detection", yolo_tracking_result.plot())
